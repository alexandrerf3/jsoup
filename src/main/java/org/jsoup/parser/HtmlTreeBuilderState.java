...
enum HtmlTreeBuilderState {
    ...
    InBody {
        private boolean processCharacterInBody(Token t, HtmlTreeBuilder tb) {
        ...
        private boolean processStartTagInBody(Token t, HtmlTreeBuilder tb) {
            Token.StartTag startTag = t.asStartTag();
        ...
        boolean process(Token t, HtmlTreeBuilder tb) {
            switch (t.type) {
                case Character: {
                    if (!processCharacterInBody(t, tb))return false;
                    break;
                }
                case Comment: {
                    tb.insert(t.asComment());
                ...
                case StartTag:
                    if (!processStartTagInBody(t, tb))return false;
                    break;
                case EndTag:
                    if (!processEndTagInBody(t, tb))return false;
                    break;
                case EOF:
